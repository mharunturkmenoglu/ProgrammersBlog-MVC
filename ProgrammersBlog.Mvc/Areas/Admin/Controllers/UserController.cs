...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(UserManager<User> userManager, IMapper mapper, IWebHostEnvironment env, SignInManager<User> signInManager, IImageHelper imageHelper)
        {
        ...
        public async Task<IActionResult> Add(UserAddDto userAddDto)
        {
            if (ModelState.IsValid)
            {
                var uploadUserImageResult = await _imageHelper.UploadUserImage(userAddDto.UserName, userAddDto.PictureFile);
                userAddDto.Picture = uploadUserImageResult.ResultStatus == ResultStatus.Success
        ...
        public async Task<IActionResult> Update(UserUpdateDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var uploadUserImageResult = await _imageHelper.UploadUserImage(userUpdateDto.UserName, userUpdateDto.PictureFile);
