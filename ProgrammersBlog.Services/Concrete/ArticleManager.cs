...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            return new Result(ResultStatus.Success, $"{article.Title} baslikli makale basariyla eklenmistir.");
        }
        ...
        public async Task<IResult> HardDelete(int articleId)
        {
            ...
            if (result)
            {
                ...
                return new Result(ResultStatus.Success, $"{article.Title} baslikli makale veritabanindan basariyla silinmistir.");
            }
            return new Result(ResultStatus.Error, "Boyle bir makale bulunamadi");
        }
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            article.ModifiedByName = modifiedByName;
            await _unitOfWork.Articles.UpdateAsync(article).ContinueWith(t => _unitOfWork.SaveAsync());
            return new Result(ResultStatus.Success, $"{article.Title} baslikli makale basariyla guncellenmistir.");
        }
    }
}